...
public @interface ESMappingProperties {
    ...
    public String search_quote_analyzer() default Empty.NULL;
...
//    public BooleanValue geohash_prefix() default BooleanValue.NULL;
    ...
    public BooleanValue coerce() default BooleanValue.NULL;
    public String copy_to() default Empty.NULL;
    public ESFieldData fielddata() default @ESFieldData();
    public ESNorms norms() default @ESNorms();
    public int position_increment_gap() default 0;
    public BooleanValue doc_values() default BooleanValue.NULL;
//    public String properties() default Empty.NULL;
    public ESLocation location() default @ESLocation();
    public BooleanValue date_detection() default BooleanValue.NULL;
    public ESAllField _all() default @ESAllField();
    public ESDefault _default_() default @ESDefault();
